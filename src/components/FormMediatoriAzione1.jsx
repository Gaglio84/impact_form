...
export default function FormMediatoriAzione1({ azione, sottoazione, opzione, onIndietro }) {
      ...
      <form onSubmit={handleSubmit} className="form-container">
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            <div className="form-col">
              <div className="form-group">
                <select name="tipologiaEnte" value={formData.tipologiaEnte} onChange={handleChange} className="form-select">
                  <option value="">Tipologia Ente</option>
                  <option value="Prefettura">Prefettura</option>
                  <option value="Ente Locale">Ente Locale</option>
                  <option value="Scuola">Scuola</option>
                  <option value="Servizio Socio-Sanitario">Servizio Socio-Sanitario</option>
            ...
            <div className="form-col">
              <div className="form-group">
                <select name="entePubblico" value={formData.entePubblico} onChange={handleChange} className="form-select">
                  <option value="">Ente Pubblico</option>
        ...
        <div className="form-section">
          <h3 className="form-section-title">Periodi Supporto Ricevuto</h3>
          ...
          <div className="form-table-group">
            <div className="form-table-row">
              ...
              <div className="form-radio-group">
                <label><input type="radio" name="capacityBuildingPrefetture" value="si" checked={formData.capacityBuildingPrefetture === 'si'} onChange={handleChange} />Si</label>
                <label><input type="radio" name="capacityBuildingPrefetture" value="no" checked={formData.capacityBuildingPrefetture === 'no'} onChange={handleChange} />No</label>
              </div>
            </div>
            ...
            <div className="form-table-row">
              ...
              <div className="form-radio-group">
                <label><input type="radio" name="capacityBuildingEntiLocali" value="si" checked={formData.capacityBuildingEntiLocali === 'si'} onChange={handleChange} />Si</label>
                <label><input type="radio" name="capacityBuildingEntiLocali" value="no" checked={formData.capacityBuildingEntiLocali === 'no'} onChange={handleChange} />No</label>
              </div>
            </div>
            ...
            <div className="form-table-row">
              ...
              <div className="form-radio-group">
                <label><input type="radio" name="formazionePersonaleScuole" value="si" checked={formData.formazionePersonaleScuole === 'si'} onChange={handleChange} />Si</label>
                <label><input type="radio" name="formazionePersonaleScuole" value="no" checked={formData.formazionePersonaleScuole === 'no'} onChange={handleChange} />No</label>
              </div>
            </div>
            ...
            <div className="form-table-row">
              ...
              <div className="form-radio-group">
                <label><input type="radio" name="formazioneDiscriminazioni" value="si" checked={formData.formazioneDiscriminazioni === 'si'} onChange={handleChange} />Si</label>
                <label><input type="radio" name="formazioneDiscriminazioni" value="no" checked={formData.formazioneDiscriminazioni === 'no'} onChange={handleChange} />No</label>
              </div>
            </div>
            ...
            <div className="form-table-row">
              ...
              <div className="form-radio-group">
                <label><input type="radio" name="formazioneSocioSanitariaOS2" value="si" checked={formData.formazioneSocioSanitariaOS2 === 'si'} onChange={handleChange} />Si</label>
                <label><input type="radio" name="formazioneSocioSanitariaOS2" value="no" checked={formData.formazioneSocioSanitariaOS2 === 'no'} onChange={handleChange} />No</label>
              </div>
            </div>
            ...
            <div className="form-table-row">
              ...
              <div className="form-radio-group">
                <label><input type="radio" name="formazioneTutelaVolontaria" value="si" checked={formData.formazioneTutelaVolontaria === 'si'} onChange={handleChange} />Si</label>
                <label><input type="radio" name="formazioneTutelaVolontaria" value="no" checked={formData.formazioneTutelaVolontaria === 'no'} onChange={handleChange} />No</label>
              </div>
            </div>
            ...
            <div className="form-table-row">
              ...
              <div className="form-radio-group">
                <label><input type="radio" name="formazioneTutelaMinori" value="si" checked={formData.formazioneTutelaMinori === 'si'} onChange={handleChange} />Si</label>
                <label><input type="radio" name="formazioneTutelaMinori" value="no" checked={formData.formazioneTutelaMinori === 'no'} onChange={handleChange} />No</label>
              </div>
            </div>
          </div>
        </div>
